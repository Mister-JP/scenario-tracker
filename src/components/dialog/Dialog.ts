...
export function initDialog(): void {
  ...
  modalOverlay = createElement<HTMLDivElement>("div", "modal-overlay");
  modalOverlay.style.display = "none";
  document.body.appendChild(modalOverlay);
  
  // Create modal content container
  modalContent = createElement<HTMLDivElement>("div", "modal-content");
 ...
 */
export function showArrowDialog(arrowId: string): void {
  ...
  // Remove button
  const removeButton = createElement<HTMLButtonElement>("button", "modal-remove-btn");
  ...
  // Create dialog body
  const body = createElement<HTMLDivElement>("div", "modal-body");
  body.innerHTML = `
